...
SCENARIOS = {
	"The Grass Llama wraps your <TYPE> Llama in thick vines",
	"The Grass Llama releases a cloud of poisonous spores towards your <TYPE> Llama",
	"The Grass Llama summons a forest of sharp thorns around your <TYPE> Llama",
	"The Grass Llama uses razor-sharp leaves to attack your <TYPE> Llama",
	"The Grass Llama causes the ground beneath your <TYPE> Llama to erupt with roots"
}
...
message_overhead = [[
Greetings trainer, I have trained for an eternity to master the Grass type Llama.
