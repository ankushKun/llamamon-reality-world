...
SCENARIOS = {
	"The Fire Llama uses a fiery charge to rush at your <TYPE> Llama.",
  "The Fire Llama creates a ring of fire around your <TYPE> Llama.",
  "The Fire Llama ignites a blaze that starts spreading toward your <TYPE> Llama.",
  "The Fire Llama breathes a stream of fire directly at your <TYPE> Llama.",
  "The Fire Llama summons a fiery meteor to fall onto your <TYPE> Llama."
}
...
message_overhead = [[
Greetings trainer, I have trained for an eternity to master the Fire type Llama.
