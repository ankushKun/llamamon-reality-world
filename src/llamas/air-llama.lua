...
SCENARIOS = {
	"The Air Llama creates a powerful gust of wind aimed at your <TYPE> Llama",
	"The Air Llama summons a tornado to trap your <TYPE> Llama",
	"The Air Llama uses a sonic screech to disorient your <TYPE> Llama",
	"The Air Llama causes a whirlwind of debris to swirl around your <TYPE> Llama",
	"The Air Llama launches a barrage of air blades at your <TYPE> Llama"
}
